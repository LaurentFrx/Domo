<script lang="ts">
  ...
  const tabs: Tab[] = [
    ...
    { href: '/pieces',   label: 'Pièces',   icon: 'M3 3 H10 V10 H3 Z M14 3 H21 V10 H14 Z M3 14 H10 V21 H3 Z M14 14 H21 V21 H14 Z' },
    { href: '/auto',     label: 'Auto.',    icon: 'M12 2 L13 8 L19 9 L13 11 L12 17 L11 11 L5 9 L11 8 Z' },
    { href: '/reglages', label: 'Réglages', icon: 'M12 2 V4 M12 20 V22 M2 12 H4 M20 12 H22 M5 5 L7 7 M17 17 L19 19 M5 19 L7 17 M17 7 L19 5 M12 8 A4 4 0 1 1 12 16 A4 4 0 1 1 12 8 Z' }
  ];
